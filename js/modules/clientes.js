// js/modules/clientes.js - Gerenciamento Completo de Clientes
// (Antigo js/clientes.js)
...
class ClientesManager {
    ...
    async loadClientes() {
        try {
            ...
            showError('Erro ao carregar clientes: ' + error.message); // Usa global
        }
    }
    ...
    async salvarClienteForm() {
        ...
        try {
            ...
            showSuccess('Cliente salvo com sucesso!'); // Usa global
            document.querySelector('.modal').remove();
            this.loadClientes();

        } catch (error) {
            console.error('Erro ao salvar cliente:', error);
            showError('Erro ao salvar cliente: ' + error.message); // Usa global
        }
    }
    ...
    async editarCliente(clienteId) {
        try {
            ...
            showError('Erro ao carregar dados do cliente'); // Usa global
        }
    }
    ...
    // (Agora usa as funções globais de js/components/modal.js)
}
