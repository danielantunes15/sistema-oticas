// js/modules/receitas.js - Controle de Receitas Oftalmológicas
// (Antigo js/receitas.js)
...
class ReceitasManager {
    ...
    async loadReceitas() {
        try {
            ...
            showError('Erro ao carregar receitas: ' + error.message); // Usa global
        }
    }
    ...
    async salvarReceita() {
        ...
        try {
            ...
            showSuccess('Receita salva com sucesso!'); // Usa global
            document.querySelector('.modal').remove();
            this.loadReceitas();

        } catch (error) {
            console.error('Erro ao salvar receita:', error);
            showError('Erro ao salvar receita: ' + error.message); // Usa global
        }
    }
    ...
    async editarReceita(receitaId) {
        try {
            ...
            showError('Erro ao carregar dados da receita'); // Usa global
        }
    }

    visualizarReceita(receitaId) {
        showSuccess('Visualização de receita em desenvolvimento'); // Usa global
    }

    usarReceitaVenda(receitaId) {
        window.dashboard.loadModule('vendas');
        showSuccess('Agora você pode usar esta receita em uma venda'); // Usa global
    }
