// js/modules/estoque.js - Controle Completo de Estoque
// (Antigo js/estoque.js)
...
class EstoqueManager {
    ...
    async loadProdutos() {
        try {
            ...
            showError('Erro ao carregar produtos: ' + error.message); // Usa global
        }
    }
    ...
    async salvarProduto() {
        ...
        try {
            ...
            showSuccess('Produto salvo com sucesso!'); // Usa global
            document.querySelector('.modal').remove();
            this.loadProdutos();

        } catch (error) {
            console.error('Erro ao salvar produto:', error);
            showError('Erro ao salvar produto: ' + error.message); // Usa global
        }
    }
    ...
    async editarProduto(produtoId) {
        try {
            ...
            showError('Erro ao carregar dados do produto'); // Usa global
        }
    }
    ...
    async executarAjusteEstoque() {
        ...
        if (!quantidade || quantidade < 0) {
            showError('Informe uma quantidade válida!'); // Usa global
            return;
        }
        ...
        try {
            ...
            showSuccess('Estoque ajustado com sucesso!'); // Usa global
            document.querySelector('.modal').remove();
            this.loadProdutos();
            this.loadMovimentacoes();
            ...
            showError('Erro ao ajustar estoque: ' + error.message); // Usa global
        }
    }
